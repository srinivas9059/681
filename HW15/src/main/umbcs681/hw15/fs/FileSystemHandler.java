...
import umbcs681.hw15.util.FileCrawlingVisitor;
...
public class FileSystemHandler implements Runnable {
    ...
    public FileSystemHandler(ConcurrentLinkedQueue<File> sharedFiles) {
    ...
    public static void createFileSystem() {
        ...
        File aTestFile = new File(src, "build.xml", 150, LocalDateTime.now());
