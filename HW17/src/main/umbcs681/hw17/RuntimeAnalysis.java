...
public class RuntimeAnalysis {
    public static Map<String, Object> analyzeMovieRuntimes(List<Movie> movies) {
        ...
        Map<Boolean, List<Movie>> partitionedMovies = movies.stream().parallel()
        ...
        double shortFilmsAvgRuntime = shortFilms.stream().parallel()
                .mapToInt(Movie::getRunTimeMinutes)
                .average()
                .orElse(0);

        double standardFilmsAvgRuntime = standardFilms.stream().parallel()
                .mapToInt(Movie::getRunTimeMinutes)
                .average()
                .orElse(0);
