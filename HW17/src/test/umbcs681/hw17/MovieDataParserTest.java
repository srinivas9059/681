...
public class MovieDataParserTest {
    ...
    public void testMonthlyReleaseAnalysis() {
        ...
        long totalMoviesInMonths = results.values().stream().parallel().mapToLong(Long::longValue).sum();

        // Get count of movies with valid release dates
        long moviesWithDates = movies.stream().parallel()
    ...
    public void testBudgetAnalysis() {
        ...
        double manualAvg = movies.stream().parallel()
